...
func TestMapRunnerForError(t *testing.T) {
	...
	_, err := NewTransformer[string, float64](floatingStrings).
		Transform(MapIt[string, float64](func(item string) (float64, error) { return strconv.ParseFloat(item, 64) })).
		Transform(MapIt[float64, float64](func(item float64) (float64, error) { return item, ErrTest })).
		Result()
...
func TestFilterItSimple(t *testing.T) {
	...
	res, err := NewTransformer[string, string](floatingStrings).
		Transform(MapIt[string, float64](func(item string) (float64, error) { return strconv.ParseFloat(item, 64) })).
		Transform(MapIt[float64, float64](func(item float64) (float64, error) { return item * 10, nil })).
		Transform(MapItSimple[float64, int64](func(item float64) int64 { return int64(item) })).
		Transform(FilterItSimple[int64](func(item int64) bool { return item%2 == 0 })).
		Transform(MapIt[int64, string](func(item int64) (string, error) { return strconv.FormatInt(item, 10), nil })).
		Transform(FilterIt[string](func(item string) (bool, error) { return item == "2", nil })).
		Result()
	if err != nil {
		t.Errorf("Testcase failed with error : %v", err)
		return
...
func TestMapItSimple(t *testing.T) {
	...
	res, err := NewTransformer[string, float64](floatingStrings).
		Transform(MapIt[string, float64](func(item string) (float64, error) { return strconv.ParseFloat(item, 64) })).
		Transform(MapItSimple[float64, float64](func(item float64) float64 { return item * 10 })).
		Result()
	if err != nil {
		t.Errorf("Testcase failed with error : %v", err)
		return
